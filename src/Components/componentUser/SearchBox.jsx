...
const SearchBox = ({ onSearch }) => {
  ...
  return (
    <form
      ...
      aria-label={t('search_rooms', { defaultValue: 'Search rooms' })}
    >
      <div className="relative flex-1">
        <input
          ...
          placeholder={t('search_placeholder', { defaultValue: 'Tìm phòng, số phòng...' })}
          ...
          required
          aria-label={t('room_search_input', { defaultValue: 'Room search input' })}
        />
