...
import { Button, Spin, Table, Input, Modal, Popconfirm, Space, Form } from 'antd';
import { ToastContainer, toast } from 'react-toastify';
import { EditOutlined, DeleteOutlined } from '@ant-design/icons';
import { getService, addService, updateService, handleDeleteService } from '../../apis/apiservice.js';
...
const ServiceManagement = () => {
    ...
    const [form] = Form.useForm(); // Sử dụng Ant Design Form để quản lý form
    ...
    const handleEditService = (record) => {
        ...
        // Đặt giá trị form dựa trên record
        form.setFieldsValue({
    ...
    const handleSaveService = async (values) => {
        ...
        try {
            ...
            setEditingService(null); // Đặt lại editingService sau khi lưu
    ...
    const handleCancel = () => {
        setIsFormVisible(false);
        setEditingService(null); // Đặt lại editingService khi hủy
        form.resetFields(); // Xóa dữ liệu form
    };
            ...
            render: (_, record) => (
                <Space>
                    ...
                    <Popconfirm
                        ...
                        onConfirm={() => handleDeleteService(record.maDichVu)}
                        okText="Xóa"
                        cancelText="Hủy"
                    >
                        <Button
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="flex-1 p-6 bg-gray-100 overflow-auto">
                    ...
                    <Modal
                        ...
                        okText="Xóa"
                        cancelText="Hủy"
                        okButtonProps={{ className: 'bg-red-500 hover:bg-blue-600' }}
                    >
